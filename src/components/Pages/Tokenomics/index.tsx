              ...
              <Box sx={{ display: "flex", gap: "27px" }}>
                ...
                <Stack>
                  ...
                  >
                    ...
                    $0.001163275. This pricing is calculated based on the value
                    of 500 ounces of gold.
                  </Typography>
                </Stack>
              </Box>
            </Stack>
              ...
              <Box sx={{ display: "flex", gap: "27px" }}>
                ...
                <Stack>
                  ...
                  >
                    ...
                    gold to back SolGold tokens, securing their intrinsic value.
                  </Typography>
                </Stack>
              </Box>
            </Stack>
            <Stack sx={{ mt: "28px", gap: "77px" }}>
              <Box sx={{ display: "flex", gap: "27px" }}>
                ...
                <Stack>
                  ...
                  >
                    SolGold implements a 4% transaction fee on all trades, which
                    is strategically reinvested into the ecosystem: 2% for
                    additional gold purchases .
                  </Typography>
                </Stack>
              </Box>
            </Stack>
